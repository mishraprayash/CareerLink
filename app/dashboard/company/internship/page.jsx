            ...
            {runningInternships && runningInternships.map((internship) => (
                <div className="border border-blue-900" key={internship._id}>
                    ...
                    <div className="flex justify-center space-x-4">
                        ...
                        <button onClick={(e) => handleSeeApplicants(e, internship._id)} className="bg-green-500 text-white px-4 py-2 rounded focus:outline-none focus:shadow-outline-green active:bg-green-600">
                            See Applicants
                        </button>
                    </div>
                </div>
