...
const CreateInternship = () => {
  ...
  return (
    <div className=" mx-auto w-[80%] p-5 my-5">
      <div className="text-3xl text-center  text-[#108A00]">
        {" "}
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        ...
        <div className="flex flex-row items-center justify-center">
          ...
          <div className="w-1/2  flex flex-col items-center ml-2 ">
            <label
              htmlFor="isRemote"
              className=" text-sm mx-2 font-medium text-gray-700"
            >
              Remote
            </label>
            <input
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="bg-blue-500 text-white p-2 rounded-md text-center flex items-center"
          >
            Create Internship
          </button>
        </div>
