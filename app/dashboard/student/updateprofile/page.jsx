...
const StudentForm = () => {
  ...
  return (
    <div className="form-group">
      <div className="font-semibold text-4xl mb-10 font-mono text-center mt-4">
        UPDATE PROFILE
      </div>
      <form className=" mx-10 my-8 px-20 py-10 bg-white rounded shadow-neutral-800 border-4 text-lg">
        <div className="text-2xl text-center mb-12 font-semibold">
          Fill out your primary information.
        </div>
        <div className="flex">
          <div className="w-1/3">
            <label className="block mb-2 text-xl font-bold text-gray-600">
              Name
            </label>
            <input
              type="text"
            ...
            />
            <label className="block mt-8 mb-2  text-xl font-bold text-gray-600">
              Gender
            </label>
            <select
              name="gender"
          ...
          <div className="w-2/3 pl-12">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full p-2 rounded h-56 border focus:outline-none"
            ></textarea>

            <label className="block mt-4 mb-2  text-xl font-bold text-gray-600">
              Bio
            </label>
            <textarea
              name="bio"
        ...
        <div className="flex justify-end">
          <button
            ...
            className="mt-8 max-w-4xl text-2xl block bg-blue-500 text-white p-2 rounded transition:1s hover:bg-pink-400 hover:-translate-y-1 hover:scale-110 duration-500 "
          >
            Submit
          </button>
        </div>
      ...
      <form className=" mx-10 my-8 px-20 py-10 bg-white rounded shadow-neutral-800 border-4 text-lg">
        <div>
          <label className="block mt-10 mb-2  text-xl font-bold text-gray-600">
            Profile Picture
          </label>
          <input
            type="file"
...
"
      ...
      <form className="mx-10 my-8 px-20 py-10 bg-white rounded shadow-black-200 shadow-lg text-lg">
        ...
        <div>
          <label
            htmlFor="campus"
            className="block mt-4 mb-2 text-xl font-bold text-gray-600"
          >
            School/Institution
          </label>
          <input
